...
A list of digests, such as an allowlist of trusted client hashes, is the same case. Note in the report that you carried it over and why, so the judgment is visible rather than silent.
